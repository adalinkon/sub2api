export default {
  ...
  admin: {
    ...
    riskControl: {
      ...
      nonHitRetentionDays: 'Non-Hit Record Retention (days, max 3650)',
      inputExcerptRunes: 'Input Excerpt Length',
      inputExcerptRunesHint: 'Number of input characters saved in logs, max 12000.',
